    ...
    <div className="container d-flex flex-column gap-4 my-4">
      ...
      <form>
        ...
        <div className='d-flex flex-column gap-2'>
          ...
          <div className='d-flex gap-2 mb-2'>
            <select required class="form-select py-3 shadow-none rounded-0 border-start-0 border-end-0">
        ...
        <div className="d-grid mt-3">
          <input type="submit" value="SAVE" className="btn btn-primary rounded-0" />
        </div>
      </form>
